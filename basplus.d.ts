...
declare module vm {
    ...
    export class Genres extends $data.Entity {
        constructor();
        constructor(initData: { Id?: Edm.String; WholesalerId?: Edm.Int32; MainGenre?: Edm.String; Description?: Edm.String });

        Id: Edm.String;
        WholesalerId: Edm.Int32;
        MainGenre: Edm.String;
    ...
    export class Articles extends $data.Entity {
        ...
        Deliverytime: Edm.Int32;
        MaxBoDays: Edm.Int32;
        Fillingrate: Edm.Int32;
        Mechanical: Edm.Decimal;
        Stock: Edm.Int32;
        FrDtType: Edm.Int32;
        SortcodeId: Edm.String;
        GenreId: Edm.String;
        Artist: Edm.String;
        Title: Edm.String;
        Eancode: Edm.String;
        ...
        OriginId: Edm.String;
        MediaId: Edm.String;
        SubmediaId: Edm.String;
        LabelId: Edm.String;
        LanguageId: Edm.String;
        StatuscodeId: Edm.String;
        Suffix: Edm.String;
        Infoline: Edm.String;
        Prefix: Edm.String;
